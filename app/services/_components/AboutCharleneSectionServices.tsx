            ...
            <div className="p-8 md:p-12 flex flex-col gap-8 md:gap-12">
              ...
              <div className="flex flex-col gap-4 md:gap-6">
                <Typography variant="body-large" as="p">
                  Charlene works with leaders carrying real responsibility,
                  often at moments where clarity, presence, and judgment matter
                  deeply.
                </Typography>

                <Typography variant="body-large" as="p">
                  Her work is grounded, thoughtful, and direct. She helps
                  leaders notice the patterns and blind spots that quietly shape
                  their decisions, relationships, and impact, especially at
                  moments of growth, transition, or pressure.
                </Typography>
