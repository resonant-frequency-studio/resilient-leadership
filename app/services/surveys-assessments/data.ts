...
export const surveysAssessmentsData: ServicePageData = {
  hero: {
    pill: 'SURVEYS & ASSESSMENTS',
    title: 'When clarity is needed across the system',
    description: [
  ...
  whenUseful: {
    pill: 'WHEN IT HELPS',
    heading: 'When surveys and assessments tend to matter most',
    intro1:
  ...
  coachingApproach: {
    pill: 'HOW IT WORKS',
    heading: 'How insight becomes actionable',
    approaches: [
      {
        title: 'In-depth organizational studies',
        description:
      ...
      {
        title: 'Targeted analysis and synthesis',
        description:
      ...
      {
        title: 'Interactive working sessions',
        description:
      ...
      {
        title: 'Clear operational guidance',
        description:
  ...
  whoThisIsFor: {
    ...
    heading: 'When understanding the system matters',
    framingParagraph: [
