...
export const changeManagementData: ServicePageData = {
  hero: {
    pill: 'CHANGE MANAGEMENT',
    title: 'When change needs to hold',
    description: [
  ...
  whenUseful: {
    pill: 'WHEN IT HELPS',
    heading: 'When change management tends to matter most',
    intro1:
  ...
  whatWorkFeelsLike: {
    ...
    phases: [
      ...
      {
        label: 'Over time',
        line1: 'Change becomes easier to navigate and less reactive.',
        line2:
  ...
  coachingApproach: {
    pill: 'HOW IT WORKS',
    heading: 'How change is supported in practice',
    approaches: [
      {
  ...
  whoThisIsFor: {
    ...
    heading: 'When the people side of change matters',
    framingParagraph: [
