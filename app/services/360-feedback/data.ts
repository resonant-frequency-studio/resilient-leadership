...
export const threeSixtyFeedbackData: ServicePageData = {
  hero: {
    pill: '360° FEEDBACK',
    title: 'When clear feedback matters',
    description: [
  ...
  whenUseful: {
    pill: 'WHEN IT HELPS',
    heading: 'When 360° feedback tends to matter most',
    intro1:
  ...
  coachingApproach: {
    pill: 'HOW IT WORKS',
    heading: 'How feedback becomes usable insight',
    approaches: [
      {
        title: 'Thoughtful, multi-source feedback',
        description:
      ...
      {
        title: 'Carefully chosen participation',
        description:
      ...
      {
        title: 'Clear synthesis and reflection',
        description:
      ...
      {
        title: 'Integrated development support',
        description:
  ...
  whoThisIsFor: {
    ...
    heading: 'Who this work is designed for',
    framingParagraph:
